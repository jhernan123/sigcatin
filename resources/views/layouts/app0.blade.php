...
<script src="{{url('/js/jquery/jquery-3.1.1.min.js')}}" type="text/javascript"></script>
<!-- LINK JQUERY REPORT - EXPORT -->
...
<!-- END LINK JQUERY REPORT - EXPORT -->
<!-- Toastr -->
<link rel="stylesheet" type="text/css" href="js/jquery/toastr.css">
...
<body>
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                     ...
                     <ul class="nav navbar-nav navbar-collapse">
                        ...
                        <li class="dropdown"><a href="{{route('report.index')}}"><span class="icon icon-search"></span>Buscar</a>
    ...
    <li class="dl-horizontal"><a href="{{route('concepto.index')}}"><span class="icon icon-checkmark"></span>Por Categoria</a></li>
        <li class="dl-horizontal"><a href="{{route('reports')}}"><span class="icon icon-calendar"></span>Por Rango de Fecha</a></li>
    </ul>  </li>
