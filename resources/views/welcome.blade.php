...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
         ...
         <link rel="stylesheet" href="{{ url('/js/csswelcome/bootstrap.min.css') }}">
        <script src="{{ url('/js/csswelcome/jquery.min.js') }}"></script>
          <script src="{{ url('/js/csswelcome/bootstrap.min.js') }}"></script>
             <link href="{{ url('/js/csswelcome/css.css?family=Raleway:100,600') }}" rel="stylesheet" type="text/css">
